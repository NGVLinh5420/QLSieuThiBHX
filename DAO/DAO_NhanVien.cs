...
namespace QLSieuThiBHX.DAO
{
    internal class DAO_NhanVien
    {
         ...
         */
        public bool AddDB_TableNhanVien(string ma, string ho, string ten, string gt, string ngs, string diachi, string sdt)
        {
            string query = "SP_ADD_NHANVIEN @MaNV , @HoNV , @TenNV , @GioiTinh , @NgaySinh , @DiaChi , @DienThoai";
            object[] param = new object[] { ma, ho, ten, gt, ngs, diachi, sdt };
         ...
         */
        public bool EditDB_TableNhanVien(string ma, string ho, string ten, string gt, string ngs, string diachi, string sdt)
        {
            string query = "SP_UPDATE_NHANVIEN @MaNV , @HoNV , @TenNV , @GioiTinh , @NgaySinh , @DiaChi , @DienThoai";
            object[] param = new object[] { ma, ho, ten, gt, ngs, diachi, sdt };
            int result = DataProvider.Instance.ExecuteNonQuery(query, param);
            return result > 0;
        }
