...
namespace QLSieuThiBHX.DAO
{
    internal class DAO_SanPham
    {
         ...
         */
        public List<DTO_SanPham> ReadDB_TableSanPham()
        {
         ...
         */
        public bool AddDB_TableSanPham(string ma, string ten, string dvt, float dg)
        {
         ...
         */
        public bool EditDB_TableSanPham(string ma, string ten, string dvt, float dg)
        {
